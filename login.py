...
def login():
    ...
    url = 'https://org.xjtu.edu.cn/openplatform/oauth/authorize?' + http_build_query({
        'appId': '1331',
        'redirectUri': 'http://rg.lib.xjtu.edu.cn:8086/auth/login/',
        'responseType': 'code',
        'scope': 'user_info',
        'state': '1287'
    })
    ...
    url = redirect_url[0] + '?' + redirect_url[1]
